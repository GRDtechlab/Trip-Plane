...
export const AI_PROMPT =
  "Generate travel plan for Location : {favouriteDestination}, for {totalDays} days for {travellers} with {budget} budget. Give me 'hotels' options array lists with name, address, price, hotelImageUrl also make sure image urls from best quality, geo coordinates, ratings, descriptions also give 'itinerary' array list of objects of  day, 'places' as array of 'day by day' with must include its placeName, details, goodTimeToVisit and travel time, imageUrls, geoCoordinates, address in JSON format.";
